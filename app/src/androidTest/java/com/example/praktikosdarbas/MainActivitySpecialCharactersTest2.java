...
public class MainActivitySpecialCharactersTest2 {
    ...
    @Test
    public void mainActivitySpecialCharactersTest2() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewWordCount), withText("Word count: 1"),
